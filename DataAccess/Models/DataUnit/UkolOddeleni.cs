...
{
    public class UkolOddeleni : IEntity
    {
        ...
        public virtual IList<UkolOddeleniMaterial> Materialy { get; set; }
        ...
        public virtual IList<UkolOddeleniHistory> History { get; set; }
        public virtual IList<string> UpraveneHodnotyVHistorii(int kolikataZHistorie)
        {
            ...
            UkolOddeleniHistory thisAsHistory = new UkolOddeleniHistory(this)
            {
                Action = this.Action
                ,
                Status = this.Status
            ...
            UkolOddeleniHistory lastHist = History[0]; //a mrkneme se na první záznam historie
        ...
        private IList<String> GetRozdilyString(UkolOddeleniHistory newer, UkolOddeleniHistory older)
        {
    ...
    public class UkolOddeleniHistory : IEntity
    {
        public virtual int Id { get; set; }
        public virtual UkolOddeleni UkolOddeleni { get; set; }
        public virtual int Action { get; set; }
        public virtual StatusUkolu Status { get; set; }
        public virtual Uzivatel Zadavatel { get; set; }
        public virtual Material Produkt { get; set; } //rolovací menu + ve formuláři pole pro zobrazení názvu
